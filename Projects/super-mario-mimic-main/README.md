...
Super Mario Bros is a trademark of Nintendo — this project is not affiliated with or endorsed by Nintendo.
=======
...
```
git clone https://github.com/gurus41/Docker-Zero-to-Hero
cd  examples
```
...
```
docker build -t gurus41/my-first-docker-image:latest .
```
...
```
    ...
    Successfully tagged gurus41/my-first-docker-image:latest
```
...
gurus41/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it gurus41/my-first-docker-image:latest
```
...
```
docker push gurus41/my-first-docker-image:latest
```
...
The push refers to repository [docker.io/gurus41/my-first-docker-image]
bfb8cff87fde: Pushed
80b8c30d0f0f: Pushed
9640eb7dc862: Pushed
b71466b94f26: Pushed
172b2af9402b: Pushed
latest: digest: sha256:034c9bea7df74b6a8e22e6b6c1d3efad1d6c27bf4bbe7769defc7b8f93d2925d size: 856

```

### You must be feeling like a champ already 

>>>>>>> 539b057f0d2009402c9d31579550b62095a1226a
